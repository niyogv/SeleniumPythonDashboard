...
class Test_dashboard:
    ...
    @pytest.fixture()  #Predefined step which run everytime before executing particular test case
    def test_invoke(self):
        ...
        assert check.text=='Hello!', 'Login failed' #Checks for validation
    ...
    def test_edit_profile(self,test_invoke):
        ...
        assert check1.text=='Save information', 'Edit profile page is broken'  #Checks for validation
    ...
    def test_update_profile(self,test_invoke):
        ...
        assert check2.text=='Save information', 'Update page is broken'  #Checks for validation
    ...
    @pytest.mark.flaky(rerun=2)  #This particular test run twice if it fails just to make sure that it is working
